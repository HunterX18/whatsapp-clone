...
function PhotoLibrary({ setImage, hidePhotoLibrary }) {
	...
	return (
		<div className="fixed top-0 left-0 max-h[100] max-w[100] h-full w-full flex justify-center items-center">
			<div className="h-max w-max bg-gray-900 gap-6 rounded-lg p-4">
				...
				<div className="grid grid-cols-3 justify-center items-center gap-16 p-2 w-full">
