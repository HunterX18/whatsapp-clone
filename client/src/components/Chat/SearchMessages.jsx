...
function SearchMessages() {
	...
	return (
		<div className="border-conversation-border w-full bg-conversation-panel-background flex flex-col z-10 max-h-screen">
				...
				<div className="flex justify-center h-full flex-col">
					...
					<div className="flex flex-col h-full w-full">
						{searchedMessages.map((message) => (
							<div className="flex cursor-pointer flex-col jusitfy-center hover:bg-background-default-hover w-full px-5 border-b-[0.1px] border-secondary p-5">
